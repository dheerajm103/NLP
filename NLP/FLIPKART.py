...
for i in range(1,21):
  ip=[]  
  url="https://www.flipkart.com/mi-4a-pro-80-cm-32-inch-hd-ready-led-smart-android-tv/product-reviews/itmfdwh5jyqhmvzg?pid=TVSG22C4DXQRVSTT&lid=LSTTVSG22C4DXQRVSTTJZD2M0&marketplace=FLIPKART&page=1"+str(i)
  ...
  minote_reviews=minote_reviews+ip  # adding the reviews of one page to empty list which in future contains all the reviews

# writng reviews in a text file 
with open("minote.txt","w",encoding='utf8') as output:
    output.write(str(minote_reviews))
	

# Joinining all the reviews into single paragraph 
ip_rev_string = " ".join(minote_reviews)
...
stop_words.extend(["redmi","mobile","time","android","phone","device","screen","note","product","good","day","price","xiaomi","miui"])
...
customised_words = ['price', "redmi","note","phone",'great'] 
...
items = list([i[0] for i in words_freq[:4206]])
