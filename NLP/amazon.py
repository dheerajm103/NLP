...
# loading mitv reviews from amazon
for i in range(1,21):
  ip=[]  
  url="https://www.amazon.in/note10/product-reviews/B089MS8NW8/ref=cm_cr_arp_d_paging_btm_next_2?ie=UTF8&reviewerType=all_reviews&pageNumber=1"+str(i)
  ...
  mitv_reviews=mitv_reviews+ip  

# writng reviews in a text file 
with open("mitv.txt","w",encoding='utf8') as output:
    output.write(str(mitv_reviews))
	

# Joinining all the reviews into single paragraph 
ip_rev_string = " ".join(mitv_reviews)
...
stop_words.extend(["mi","tv","read","android","flipkart","devIce","screen","flipkart","money","good","day","price","xiaomi","miui"])
